...
<div id="newsletter_block_left" class="block">
	...
	<!-- <h4 class="txt__big news__title">{l s='Newsletter' mod='blocknewsletter'}</h4> -->
	<h4 class="txt__big news__title">Registra tu correo y obten mas informacion sobre descuentos y ofertas especiales.</h4>
